			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<fmt:message code="common.gestion.article" />
							</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#"><fmt:message
											code="common.gestion.article" /></a></li>
								<li class="breadcrumb-item active"><fmt:message
										code="common.nouveau.article" /></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<fmt:message code="common.nouveau.article" />
						</h3>
										...
										<c:url value="/article/enregistrer" var="enregisterArticle" />
											...
											<f:hidden path="idArticle"/>
												<div class="form-group">
													<label><fmt:message code="common.article.code" /></label> 
													<f:input path="codeArticle" class="form-control form-control-sm" type="text" placeholder="Entrez le code..." />
													<f:errors path="codeArticle" cssClass="alert alert-warning" element="div" />
												</div>
												<div class="form-group">
													<label><fmt:message code="common.article.designation" /></label>
													<f:input path="designation" class="form-control form-control-sm" placeholder="Entrez la désignation..." />
