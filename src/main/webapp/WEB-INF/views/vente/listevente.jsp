		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<fmt:message code="common.vente.list.button" />
							</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#"><fmt:message code="common.vente.gestion"/></a></li>
								<li class="breadcrumb-item active"><fmt:message code="common.vente.list.archive" /></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<section class="content">
              ...
              <div class="card-header" style="background-color: #C2F7A9; ">
                <h3 class="card-title"><fmt:message code="common.vente.list.valide" /></h3>
              </div>
              <div class="card-body p-0">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
	                  <c:forEach items="${ventesValider}" var="valider">
		                  <tr>
		                  		<td>${valider.getCode()}</td>
		                  		<td>${valider.getDateVente()}</td>
		                  		<td>${valider.getNomClient()}</td>
			...
			<div class="card" id="detailVente">
              <div class="card-header" style="background-color: #F58198;">
                <h3 class="card-title"><fmt:message code="common.vente.list.rejete" /></h3>
              </div>
              <div class="card-body p-0">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
	                  ...
	                  <tbody>
						  <c:forEach items="${ventesRejeter}" var="rejeter">
		                  	<tr>
		                  		<td>${rejeter.getCode()}</td>
		                  		<td>${rejeter.getDateVente()}</td>
		                  		<td>${rejeter.getNomClient()}</td>
