			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<fmt:message code="common.liste.category" />
							</h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="#"><fmt:message code="common.category" /></a></li>
								<li class="breadcrumb-item active"><fmt:message
										code="common.liste.category" /></li>
							</ol>
						</div>
					</div>
				</div>
					...
					<div class="card-header">
						<h3 class="card-title">
							<button type="button" class="btn  btn-outline-primary btn-sm"
								...
								<a href="<c:url value="/category/nouveau" />" id="hover"> 
								<fmt:message code="common.ajouter.category" /></a>
							</button>
							<button type="button" class="btn  btn-outline-primary btn-sm"
								style="margin-right: 5px;">
											...
											<table id="example1"
												...
												<thead>
													<tr>
														...
														<th><fmt:message code="common.category.designation" /></th>
													</tr>
												</thead>
												<tbody>
															...
															<td style="width: 200px !important;">
																<h3 class="card-title">
																	...
																	<button type="button"
																		...
																		<c:url
																			value="/category/modifier/${categorie.getIdCategory()}"
																			var="urlModifier" />
																	...
																	<button type="button"
																		...
																		data-target="#suppressionModal${categorie.getIdCategory()}"
																		id="hover">
																	...
																	<div class="modal fade"
																		id="suppressionModal${categorie.getIdCategory()}"
																		...
																		<div class="modal-dialog" role="document">
																			<div class="modal-content">
																				...
																				<div class="modal-body">
																					<fmt:message code="common.confirmation.msg.category" />
																					${categorie.getCode()} ??
																				</div>
																				<div class="modal-footer">
																					...
																					<c:url
																						value="/category/supprimer/${categorie.getIdCategory()}"
																						var="urlSupprimer" />
